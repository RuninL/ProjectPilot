...
| **v1.1（自动验收完成，真机待验）** | 人物、参与人、已推迟、并行甘特与全局文件                               | migration 0007/0008；人物列表与二级详情；项目/任务参与关系独立维护及 OR 筛选；自由切换的 postponed；跨项目并行甘特；`/files`；人员 JSON/CSV/备份兼容                                                                                                                                                                                                                      | 自动测试与构建通过；Windows opener 和备份恢复保留真机确认 |
